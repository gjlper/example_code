...
class CNN(object):
    ...
    def define_train_operations(self):
        ...
        self.valid_loss = tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.Y_data_valid, logits=Y_net_valid, name='valid_loss'))
    ...
    def define_predict_operations(self):
        ...
        self.Y_net_test              = tf.cast(self.inference(self.X_data_test_placeholder,self.keep_prob_placeholder ,reuse = False,is_training=False) > 0.5, tf.float32)
